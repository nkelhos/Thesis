...
\section{Dark Matter}
  ...
  From both cosmology and particle physics, the WIMP is predicted to have a mass in the range of GeV to TeV, and a velocity-averaged self-annihilation cross section $\vacs$ of around \nicetilde{}\SI{3e-26}{cm${}^3$s${}^{-1}$}.
...
\section{Halo Analysis}
  ...
  For the spectral shape, only the \bbbar annihilation channel is used, as discussed in Section~\ref{dm_spectral}.
  ...
  %   search "Concerning the maximal value of the DM mass"
  % "GeV-scale thermal WIMPs: Not even slightly ruled out"
  %   doi.org/10.1103/PhysRevD.98.023016
  %   search "To decisively test thermal WIMPs, the sensitivity on the"
  % "Unitarity Limits on the Mass and Radius of Dark-Matter Particles"
  %    https://journals.aps.org/prl/pdf/10.1103/PhysRevLett.64.615
