...
\section{Indirect Dark Matter Search}
  ...
  \subsection{Spectrum of Gamma Rays from WIMP Annihilations}\label{dm_spectral}
    ...
    However, only the $\chi\chi \rightarrow b\bar{b}$ channel is considered for this analysis.
    ...
    This is done by repeatedly simulating all the photons produced when the $b$ quarks decay into other particles.
    Several of these decays are shown in Table~\ref{tab:bpaths2}.
    In the first row, a \APbottom quark will hadronize into either a \PBplus or \PBzero meson 41.2\% of the time.
    The \PB mesons can then decay into \PK and \PD mesons at various percentages (plus some other particles $X$), and the \PD mesons also decay into \PK mesons.
    The \PK mesons can then decay into \Ppiplusminus and \Ppizero mesons, and then the \Ppizero decays into two photons.
    {\color{red}(change the sentence about hadronization, the value 41.2\% is not actually correct and it is enough tos ay something like 'The b quarks hadronize to a B meson, which in turn decay into D or K mesons.  Photons are produced through the K decays, as detailed in Table~\ref{tab:bpaths2}. --orel??)}
    ...
    \begin{table}
      ...
      \begin{tabular}{ccll}
        ...
        \APbottom                    & $\xrightarrow{ 41.2 \pm0.8 }$   & \PBp, \PBz     & \href{http://pdg.lbl.gov/2018/reviews/rpp2018-rev-b-meson-prod-decay.pdf}{\Pbottom-Hadron Production}              \\ \hline
        \PBp     $(\Pup\APbottom)$   & $\xrightarrow{ 79   \pm4   }$   & $\APDzero + X$ & \href{http://pdg.lbl.gov/2018/listings/rpp2018-list-B-plus-minus.pdf}{Charged B Mesons}          \\
        \PBz     $(\Pdown\APbottom)$ & $\xrightarrow{ 78   \pm8   }$   & $\PKpm + X$    & \href{http://pdg.lbl.gov/2018/listings/rpp2018-list-B-zero.pdf}{Neutral B Mesons}          \\
        \PBz     $(\Pdown\APbottom)$ & $\xrightarrow{ 47.4 \pm2.8 }$   & $\APDzero + X$ & \href{http://pdg.lbl.gov/2018/listings/rpp2018-list-B-zero.pdf}{Neutral B Mesons}          \\
        \PBz     $(\Pdown\APbottom)$ & $\xrightarrow{ 36.4 \pm3.3 }$   & $\PDminus + X$ & \href{http://pdg.lbl.gov/2018/listings/rpp2018-list-B-zero.pdf}{Neutral B Mesons}          \\ \hline
        \APDzero $(\Pup\APcharm)$    & $\xrightarrow{ 45.7 \pm2.8 }$   & $\PKplus + X$  & \href{http://pdg.lbl.gov/2018/tables/rpp2018-tab-mesons-charm.pdf}{Charm Mesons}          \\
        \PDminus $(\Pdown\APcharm)$  & $\xrightarrow{ 25.7 \pm1.4 }$   & $\PKplus + X$  & \href{http://pdg.lbl.gov/2018/tables/rpp2018-tab-mesons-charm.pdf}{Charm Mesons}          \\ \hline
        \PKplus  $(\Pup\APstrange)$  & $\xrightarrow{ 20.67\pm0.08}$   & $\Ppizero + \Ppiplus$  & \href{http://pdg.lbl.gov/2018/tables/rpp2018-tab-mesons-strange.pdf}{Strange Mesons} \\
        \PKminus $(\APup\Pstrange)$  & $\xrightarrow{ 20.67 \pm0.08 }$ & $\Ppizero + \Ppiminus$  & \href{http://pdg.lbl.gov/2018/tables/rpp2018-tab-mesons-strange.pdf}{Strange Mesons} \\ \hline
        \Ppizero $\left ( \frac{\Pup\APup-\Pdown\APdown}{\sqrt{2}} \right )$   & $\xrightarrow{ 98.823\pm0.034}$ & $\gamma + \gamma$ & \href{http://pdg.lbl.gov/2018/listings/rpp2018-list-pi-zero.pdf}{Neutral Pion} \\
        %$$ & $\xrightarrow{ \pm }$ & $$ \\
      ...
      \caption[$b$ Quark Production of Gamma Rays]{
        Table of decay modes and products, indicating several ways photons are produced from $b$ quarks.
        ...
        {\color{red}(remove first $b \rightarrow B^{+},B^0$ row?? -orel)}
      }
      \label{tab:bpaths2}
    \end{table}
