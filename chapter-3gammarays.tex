  ...
  \subsection{Spectrum of Gamma Rays from WIMP Annihilations}\label{dm_spectral}
    ...
    \begin{table}
      ...
      \begin{tabular}{ccll}
        ...
        \PBz     $(\Pdown\APbottom)$ & $\xrightarrow{ 78   \pm8   }$   & $\PKpm + \mathrm{anything}$    & \href{http://pdg.lbl.gov/2018/listings/rpp2018-list-B-zero.pdf}{Neutral B Mesons}          \\
        ...
        \APDzero $(\Pup\APcharm)$    & $\xrightarrow{ 45.7 \pm2.8 }$   & $\PKplus + \mathrm{anything}$  & \href{http://pdg.lbl.gov/2018/tables/rpp2018-tab-mesons-charm.pdf}{Charm Mesons}          \\
        \PDminus $(\Pdown\APcharm)$  & $\xrightarrow{ 25.7 \pm1.4 }$   & $\PKplus + \mathrm{anything}$  & \href{http://pdg.lbl.gov/2018/tables/rpp2018-tab-mesons-charm.pdf}{Charm Mesons}          \\ \hline
      ...
      \caption[$b$ Quark Production of Gamma Rays]{
        ...
        The component $X$ and 'anything' indicate other particles.
        Branching ratios and Particle Data Group (PDG) chapters are from Ref.~\cite{tanabashi2018review}.
        {\color{red}(post question about difference between $X$ and $anything$ in pdg docs??)}
      }
      \label{tab:bpaths2}
    \end{table}
