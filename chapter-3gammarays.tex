...
\section{Production of TeV Gamma Rays}
  ...
  \begin{figure}[!p]
    ...
    %\includegraphics[width=0.75\textwidth]{images/snr_shockfront/matplotlib_replot/merged_spectra.pdf} \\
    
    %\begin{tabular}{m{10cm}}
    \begin{tabular}{c}
      \includegraphics[width=0.85\textwidth]{images/snr_shockfront/matplotlib_replot/spectral_index_contours.pdf} \\
      \includegraphics[width=0.85\textwidth]{images/snr_shockfront/matplotlib_replot/differential_spectra.pdf} \\
    \end{tabular}
...
\section{Galactic Center}\label{sec:gc}
  ...
  While a dark matter interpretation of this gamma-ray emission is intriguing~\cite{Belikov2012ty,Cembranos2012}, there are several non-dark-matter models that might explain the observed features.
...
\section{Indirect Dark Matter Search}
  ...
  \subsection{Dark Matter Halo Structure}\label{dm_spatial}
    ...
    In Figure~\ref{fig:gchalo_jfactor}, the profile shown is calculated with Equation~\ref{eqn:jfactor}, where the $d\Omega$ integration limits span a radial angle of \ang{0.06}.
