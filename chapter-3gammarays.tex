...
Because analysis searches for dark matter using gamma rays, a discussion of gamma rays and their properties is necessary.
...
\section{Production of TeV Gamma Rays}
  ...
  {\color{red}(check equations are numbered properly??)}
  ...
  \subsection{Dark Matter Interactions}\label{dmgammaproduction}
    ...
    {\color{red}(pause in parents commenting??)}
