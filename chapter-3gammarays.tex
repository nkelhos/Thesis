...
\section{Indirect Dark Matter Search}
  ...
  \subsection{Spectrum of Gamma Rays from WIMP Annihilations}\label{dm_spectral}
    ...
    {\color{red}(change the sentence about hadronization, the value 41.2\% is not actually correct and it is enough tos ay something like 'The b quarks hadronize to a B meson, which in turn decay into D or K mesons.  Photons are produced through the K decays, as detailed in Table~\ref{tab:bpaths}. --orel??)}
