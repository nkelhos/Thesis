...
\section{Galactic Center}
  ...
  There are other gamma-ray sources as well, including dust along the galactic plane and supernova remnants {\color{red}(is there a graphic that illustrates the diversity??)}.
...
\section{Indirect Dark Matter Search}
  ...
  \subsection{Spectrum of Gamma Rays from WIMP Annihilations}\label{dm_spectral}
    ...
    {\color{red}(this is the only part where it is really discussed what is going into the particle physics term; all what is cited are software packages. ?? --gernot)}
