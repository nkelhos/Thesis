...
\section{Indirect Dark Matter Search}
  ...
  \subsection{Spectrum of Gamma Rays from WIMP Annihilations}\label{dm_spectral}
    ...
    In the rows two through five, the \PB mesons can then decay into \PK and \PD mesons at various percentages (plus some other particles $X$), and in rows six and seven the \PD mesons also decay into \PK mesons.
    In rows eight and nine, the \PK mesons can then decay into \Ppiplusminus and \Ppizero mesons, and then the \Ppizero decays into two photons.
    ...
    \begin{table}
      \centering
      \begin{tabular}{ccll}
        Source                       & Branching                       & Products       & Reference \\
        (Quarks)                     & Ratio (\%)                      &                & Document \\ \hline
      ...
      \caption[$b$ Quark Production of Gamma Rays]{
        Table of decay modes and products, indicating several ways ways a lone $b$ quark can indirectly produce photons.
        The component $X$ indicates other particles.
        Branching ratios and reference documents are from Ref.~\cite{tanabashi2018review}.
        {\color{red}(ask about inclusive vs exclusive modes??)}
        {\color{red}(in pdg docs, difference between $X$ and $anything$??)}
        {\color{red}(remove hyperlinks??)}
      }
      \label{tab:bpaths2}
    \end{table}
