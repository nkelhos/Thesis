...
\section{Galactic Center}
  ...
  The VERITAS significance skymap of this Galactic Center region is shown in Figure~\ref{fig:veritas_gc_ridge}.
  ...
  This is because the atmosphere's lack of uniformity overwhelms any diffuse emission in the residual skymaps\footnote{These residual maps are discussed in Section~\ref{subsec:likemax}.}.
...
\section{Indirect Dark Matter Search}
  ...
  \subsection{Spectrum of Gamma Rays from WIMP Annihilations}\label{dm_spectral}
    ...
    Three example Feynman diagrams of WIMP annihilations that produce a $b\bar{b}$ pair are shown in Figure~\ref{fig:neutralino_feynman}, adapated from Ref.~\cite{Jungman:1995df}.
    ...
    After the desired channel is selected, the spectrum of final radiated photons is calculated.
    ...
    The variable $k_T$ is the transferse momentum, and $\Delta_S(Q^2_1,Q^2_2)$ is the Sudakov form factor~\cite{sudakov}, the probability of progressing from $Q^2_1$ to $Q^2_2$ without any radiation.
