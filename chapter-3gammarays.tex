...
\section{Indirect Dark Matter Search}
  ...
  \subsection{Spectrum of Gamma Rays from WIMP Annihilations}\label{dm_spectral}
    ...
    Then, the $b$ quarks may hadronize into $b$-hadrons, or they may decay into other particles, shown in Table~\ref{tab:bpaths}.
    In the first three rows, a $\bar{b}$ quark decays into a $\bar{D}^0$ quark and some other particles in 59.8\% of all $\bar{b}$ decays.
    The $\bar{D}^0$ then decays 54.7\% of the time into a $K^+$ and some other particles, and then finally the $K^+$ decays into a $\mu^+ + \nu_{\mu}$ pair.
    The $\mu^+$ can then go on to produce photons via bremsstrahlung or through annihilating with an ambient $\mu^-$.
