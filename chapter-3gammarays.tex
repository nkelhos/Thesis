...
\section{Indirect Dark Matter Search}
  ...
  \subsection{Spectrum of Gamma Rays from WIMP Annihilations}\label{dm_spectral}
    ...
    After the desired channel is selected, the amount of {\color{red}bremsstrahlung radiation (you wont get bremsstrahlung from the quarks (at least not photons) ?? -orel)} from the initial $b$ and $\bar{b}$ particles {\color{red}must be calculated (what does it mean, 'must be calculated'?? -orel)}.
    ...
    The $\mu^+$ can then go on to produce photons via bremsstrahlung or through annihilation with an ambient $\mu^-$ {\color{red}(there are no ambient muons?? -orel)}.
