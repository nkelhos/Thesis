...
\section{Indirect Dark Matter Search}
  ...
  \subsection{Spectrum of Gamma Rays from WIMP Annihilations}\label{dm_spectral}
    ...
    In the first row, a \APbottom quark will hadronize into either a \PBplus or \PBzero meson.
    ...
    The \PK mesons can then decay into \Ppipm and \Ppizero mesons, and then the \Ppizero{}'s decay into two photons.
    {\color{red}(change the sentence about hadronization, it is enough to say something like 'The b quarks hadronize to a B meson, which in turn decay into D or K mesons.  Photons are produced through the K decays, as detailed in Table~\ref{tab:bpaths2}. --orel??)}
    ...
    \begin{table}
      ...
      \begin{tabular}{ccll}
        ...
        \APbottom                    & $\xrightarrow{ \mathrm{Hadronization} }$   & \PBp, \PBz     & \href{http://pdg.lbl.gov/2018/reviews/rpp2018-rev-b-meson-prod-decay.pdf}{\Pbottom-Hadron Production}              \\ \hline
    ...
    \begin{figure}[bt]
      ...
      \caption[Single Annihilation Spectra]{
        Resultant photon spectra from the annihilation of two WIMP particles solely into the $b\bar{b}$ channel.
