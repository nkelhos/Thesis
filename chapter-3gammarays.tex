...
\section{Indirect Dark Matter Search}
  ...
  \subsection{Spectrum of Gamma Rays from WIMP Annihilations}\label{dm_spectral}
    ...
    After the desired channel is selected, the $b$ quark hadronizes into a $b$ meson or hadron, which then decay into other particles, shown in Table~\ref{tab:bpaths2}.
    ...
    \begin{table}
      ...
      \begin{tabular}{ccll}
        ...
        \PKplus  $(\Pup\APstrange)$  & $\xrightarrow{ 20.67\pm0.08}$   & $\Ppiplus  + \Ppizero$  & \href{http://pdg.lbl.gov/2018/tables/rpp2018-tab-mesons-strange.pdf}{Strange Mesons} \\
        \PKminus $(\APup\Pstrange)$  & $\xrightarrow{ 20.67 \pm0.08 }$ & $\Ppiminus + \Ppizero$  & \href{http://pdg.lbl.gov/2018/tables/rpp2018-tab-mesons-strange.pdf}{Strange Mesons} \\ \hline
    ...
    The $\mu^+$ can then go on to produce photons via bremsstrahlung {\color{red}(avoid talking about muons, most photons are from pi\_0s)} or through annihilation with an ambient $\mu^-$ {\color{red}(there are no ambient muons?? -orel) (lifetime is too short to matter)}.
