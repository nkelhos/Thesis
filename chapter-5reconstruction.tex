...
{\color{red}(talk about this for a few sentences??)}
...
\section{Camera Studies}
  ...
  \subsection{Background Structure at the Low Energy Threshold}\label{subsec:bkgstructure}
    ...
    This was done to reduce any effects of a large range of telescope elevations, which observe a large range of atmosphere depths {\color{red}(is this better?? -maria)}.
