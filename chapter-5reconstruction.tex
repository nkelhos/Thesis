...
\begin{figure}[th]
  \centering
  \includegraphics[width=0.5\textwidth]{images/mscw_table_plots/mrsw_crab.pdf} &
  \caption[Crab Nebula Mean Reduced Scaled Width]{
    ...
    The green histogram is the MRSWs for events within \ang{0.25} of the Crab Nebula, and should contain many gamma-ray events.
    The red histogram is the MRSWs for events in several off regions, which should only contain proton-induced showers.
    ...
    {\color{red}(rasterize bars??)}
    {\color{red}(Crab Nebula in title??)}
    {\color{red}(triple bin size??)}
