...
\section{Camera Studies}
  ...
  \subsection{Background Structure at the Low Energy Threshold}\label{subsec:bkgstructure}
    ...
    \begin{figure}[bt]
      \centering
      \includegraphics[width=0.6\textwidth]{images/background_gradient_replot/sgraoff_23_hist_elev.pdf}
    ...
    The left histograms show the number of events at each energy, with the expected higher number of events at lower energies.
    ...
    These 2D histograms are almost identical to the camera backgrounds described in Section~\ref{background_production}.
    
    \begin{figure}[p]
      \centering
      \begin{tabular}{rl}
        \subfloat{\includegraphics[width=7.5cm]{images/background_gradient_replot/sgraoff_23_hist_energy.pdf}} & 
        \subfloat{\includegraphics[width=4.5cm]{images/background_gradient_replot/sgraoff_23_cam.pdf}}         \\
        \subfloat{\includegraphics[width=7.5cm]{images/background_gradient_replot/sgraoff_24_hist_energy.pdf}} & 
        \subfloat{\includegraphics[width=4.5cm]{images/background_gradient_replot/sgraoff_24_cam.pdf}}         \\
        \subfloat{\includegraphics[width=7.5cm]{images/background_gradient_replot/sgraoff_25_hist_energy.pdf}} & 
        \subfloat{\includegraphics[width=4.5cm]{images/background_gradient_replot/sgraoff_25_cam.pdf}}         \\
        \subfloat{\includegraphics[width=7.5cm]{images/background_gradient_replot/sgraoff_26_hist_energy.pdf}} & 
        \subfloat{\includegraphics[width=4.5cm]{images/background_gradient_replot/sgraoff_26_cam.pdf}} 
      \end{tabular}
      \caption{
        ...
        Right is a 2D histogram of the azimuth and elevation of selected events from the histogram to its left.
      }
    ...
    This allows lower-energy gamma rays and their shower's Cherenkov light to get closer to the observatory.
    Below this energy, gamma rays do not produce enough Cherenkov light for even a handful of Chernekov photons to reach the observatory.
    The bottom of the camera has more atmosphere however, and is considered opaque to gamma rays \SI{2.5}{TeV} and lower.
