...
\section{Veritas Data}\label{veritasdata}
  ...
  One set contains observations of the Crab Nebula, another of the Galactic Center.
...
\section{Likelihood Ratio Test}\label{sec:likeratio}
  ...
  In this equation, $n$ is the number of observed events, and $m$ is the number of events a model group predicts.
  ...
  These could be bins of events in sky position, energy, time, or other event parameters, or any combination of these parameters.
  ...
  When the bin size is infinitely small, $m_i$ becomes the value of the probability density function (of all models combined) at the position of the event, $P_i$, as in Equation~\ref{eqn:simple_like_8}.
  ...
  The unbinned Equation~\ref{eqn:simple_like_8} is how the log-likelihood is calculated in this analysis.
  ...
  \begin{equation}\label{eqn:modelparts}
    M(l,b,E,t) = M_s(l,b,E,t) \; \times \; M_e(l,b,E,t) \; \times \; M_t(l,b,E,t)
  \end{equation}
  ...
  {\color{red}For a basic power law (reword?? -parents)}, the spectral model function $M_e$ is shown in Equation~\ref{eqn:powerlaw_Me}.
  ...
  The Crab Nebula model also has its location parameters $l_c$ and $b_c$, but since these are fixed in this example (and thesis), the likelihood maximization can't vary them.
...
\section{Crab Nebula Likelihood Analysis}\label{sec:crab_analysis}
  ...
  The Crab was modeled by a point source with the simple power law spectrum in Equation~\ref{eqn:crab_model}.
  ...
  The pivot energy $E_o$ of its spectrum was fixed at \SI{16.73}{TeV}, while the normalization $N_o$ and the spectral index $\gamma$ are free to vary during the likelihood optimization.
  ...
  In order to ensure there are enough simulations to properly populate the high-energy end of the IRFs, the analysis was limited to a maximum event energy of \SI{70}{TeV}.
