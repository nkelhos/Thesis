...
\section{Dark Matter Likelihood Analysis}\label{sec:dmlike}
  ...
  Using Wilk's theorem~\cite{wilks1938} with a likelihood ratio with one free parameter, a TS value greater than 20 would hint at the presence of a dark matter halo.
  As all of these are less than zero, it shows that the null (no dark matter) hypothesis is statistically favorable.
  ...
  Figure~\ref{fig:gc_profile_energy} shows the same profile, except integrated over a \ang{0.2}$\times$\ang{0.2} galactic (l,b) square centered on Sgr A*.
