...
\section{Dark Matter Likelihood Analysis}\label{sec:dmlike}
  ...
  \begin{equation}\label{eqn:brokenplaw}
    M_e(\xtrue) = M_s(\ltrue,\btrue,\Etrue,\ttrue) = N_o * { \left ( \frac{\Etrue}{E_{pivot}} \right ) }^{\gamma} {e}^{-\frac{E}{E_{cut}}}
  \end{equation}
  ...
  The normalization parameter $N_o$ was initially set to $2.8*{10}^{-12}\,\text{cm}^{-2}\,\text{s}^{-1}\,\text{TeV}^{-1}$, but was left free in the likelihood optimization, while $E_{pivot}$, $E_{cut}$, and $\gamma$ were all fixed.
