...
\section{Test Point Sources}
  ...
  \subsection{Test Crab Analysis}\label{subsec:crab_analysis}
    ...
    This resulted in {\color{red}(??)} minutes of V5 epoch data, and {\color{red}(??)} minutes of V6 epoch data.
    ...
    \begin{figure}[h]
      \centering
      \includegraphics[width=0.95\textwidth]{images/test_crab_analysis/plot_elev27_5_32_5deg_4_70TeV_wobbleall_Epochall_showclean_spl.eps}
    ...
    \begin{figure}[h]
      \centering
      \includegraphics[width=0.95\textwidth]{images/test_crab_analysis/plot_elev27_5_32_5deg_4_70TeV_wobbleall_Epochall_showclean_spb.eps}
    ...
    \begin{figure}[h]
      \centering
      \includegraphics[width=0.95\textwidth]{images/test_crab_analysis/plot_elev27_5_32_5deg_4_70TeV_wobbleall_Epochall_showclean_splalt.eps}
