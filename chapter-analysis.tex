...
\section{Test Point Sources}
  ...
  \subsection{Test Crab Analysis}\label{subsec:crab_analysis}
    ...
    After fitting all events from \SIrange{4}{70}{TeV}, with a pivot energy $ E_{0}= \SI{10}{TeV} $, the $ I_{0} = \left(1.472\pm0.09\right)*10^{-19} \frac{ph}{cm^{2} s MeV} $, $ \gamma = 2.382 \pm 0.076 $, with a Test Statistic of 1929.01. {\color{red}(?? update values!)}.
...
\section{Dark Matter Likelihood Analysis}
  ...
  {\color{red}(Also look at 2016 paper: \url{http://iopscience.iop.org/article/10.3847/0004-637X/821/2/129/meta}! ??}
  ...
  \begin{figure}[ht]
    ...
    \caption[Galactic Center Counts Energy Histogram]{
      ...
      No adjustments for effective area, observation time, or background rate is done here.
    }
...
\section{Upper Limit}
  ...
  \begin{figure}[ht]
    ...
    \caption[Dark Matter Upper Limit Plot]{
      ...
      For reproduction, data values from this work are in the Appendix, Table \ref{tab:ulimvals}.
      The relic cross-section limit is from \cite{updatedWIMPRelicCrossSection}.
      {\color{red}(Do I need to incorporate the systematic uncertainty in this, or is this already accounted for by the energy migration matrices??)}
  ...
  From relative differences between the total counts and observed counts in Figures \ref{fig:gc_profile_gal_l} and \ref{fig:gc_profile_gal_l}, a gradient of 5\%/\degree{} was chosen.
  ...
  Thus, any strong effect in the background models of the numerator likelihood is mitigated by also being in the denominator.
