...
This implies a key idea, that if one wishes to study the effect of stars, instead one should study the effect of high-current or disabled camera pixels.
To examine the effects of disable pixels, several studies were undertaken.
