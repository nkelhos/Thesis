...
\section{Studies}
As part of exploring the behavior of the camera and reconstruction process, some studies were carried out.
These included examining how shower reconstructed is affected by the presence of stars in the field of view.
...
For particularly bright stars (magnitude <= 3), several pixels are often disabled at a given time.
...
This implies that to study the effect of stars, one must study the effect of high-current or disabled camera pixels, and use this information to construct the effect of stars.
...
\section{Test Galactic Center Analysis}
