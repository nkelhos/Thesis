...
\section{Background Models}\label{sec:bkgmodels}
  ...
  {\color{red}(skymap of GC and GC Off runs??)}
  ...
  It should be noted that CTOOLS backgrounds are in RA/DEC detector coordinates, instead of Az/El detector coordinates. {\color{red}(??)}
