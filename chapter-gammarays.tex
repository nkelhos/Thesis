...
\section{Production of TeV Gamma Rays}
  ...
  In these strong magnetic fields, ambient photons can convert into $e^{+}e^{-}$~\cite{pwn_pairprod1,pwn_pairprod2}.
  ...
  where $E$ is the photon energy, $H$ is the ambiant magnetic field strength, $e$ is the electron charge, and $m$ is the mass of the electron~\cite{pwn_pairprod3}.
  The factor $\frac{e \hbar}{m^2c^3}$ forms a critical magnetic field strength, which for electrons is $\frac{1}{4.4\times10^{13}\,\textrm{Gauss}}$, similar in scale to the pulsar's surface magnetic field strength.
