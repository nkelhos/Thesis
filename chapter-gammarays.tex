...
\section{Indirect Dark Matter Search}
  ...
  \subsection{Spectrum of Gamma Rays from Dark Matter}\label{dm_spectral}
    ...
    These tables are generated using monte carlo simulations with PYTHIA~\cite{pythia} and HERWIG~\cite{}.
    % ?? also include ew correctons? \cite{pppc4_ewcorrections}
    ...
    \begin{figure}[ht]
      ...
      \caption[Single Annihilation Spectra]{
        ...
        {\color{red}(how do we get these plots from PPPC4 tables??)}}
