...
\section{Atmospheric Showers}
  ...
  \begin{figure}[ht]
    \centering
    \includegraphics[width=0.35\textwidth]{images/CherenkovReactor/cherenkovreactor.eps}
    \caption[Chernekov Light from a Reactor]{
      Cherenkov light in the Advanced Test Rector core, at the Idaho National Laboratory \cite{cherenkovreactor,atrlab}.
    }
