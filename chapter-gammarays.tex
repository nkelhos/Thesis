...
\section{Production of TeV Gamma Rays}
  ...
  Another mechanism that produces high-energy charged particles is located at supernova shockfronts, called diffuse shock acceleration.
  ...
  snr spectral index plots go here.
  
  \cite{dsa1,dsa2,dsa3,dsa4,dsa5}
...
\section{Indirect Dark Matter Search}
  ...
  \subsection{Spectrum of Gamma Rays from Dark Matter}\label{dm_spectral}
    ...
    These spectra can be combined with the J factor Equation~\ref{eqn:jfactor} to calculate Equation~\ref{eqn:dmflux}: how many gamma rays are produced by the halo\footnote{
      These spectra are stored in an interpolation table, which can be used as the spectral component $M_{\textrm{e,halo}}$ for the dark matter halo model in the likelihood analysis in Equation~\ref{eqn:dmmodel}, detailed further in Section~\ref{subsec:dmhalomodel}.
    }.
