...
\section{Production of TeV Gamma Rays}
  ...
  Because pulsars spin rapidly, they produce a significant magnetic fields.
  The Crab nebula for instance has a surface magnetic field strength of \SI{e12}{G}~\cite{pwn_evolution}, much larger than Earth's \approx{}\SI{0.5}{G}~\cite{earth_geomag}.
  {\color{red}(why no line numbers??)}
