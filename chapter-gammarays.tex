...
\section{Production of TeV Gamma Rays}
  ...
  A gamma ray can start as a {\color{red}thermal photon (it can't start as a thermal photon. At low energies is its most probably produced by thermal processes -maria??)}, then gain significant energy from electroweak interactions with electrons, referred to as a leptonic production.
  ...
  These magnetic field lines occasionally {\color{red}break and reconnect (why do they break and reconnect?? -maria)}, which temporarily create electric fields that can accelerate electrons outwards to higher energies than thermal sources (i.e. solar wind) alone can achieve~\cite{gamma_pwn1,gamma_pwn2}.

  {\color{red}(You mention that electrons are produced here (first sentence) but then, you only talk about charged particles. Are these charged particles electrons or also protrons?
What you describe here is the acceleration mechanism, not the production mechanism. -maria ??)}
  ...
  In hadronic processes, protons can be accelerated ($p_{accel}$) by Fermi acceleraton or as part of an {\color{red}Active Galactic Nucleus jet (only these to options to accelerate protrons? what is with protrons in SNRs?? -maria)}~\cite{hadronic1,hadronic2}.
  ...
  \subsection{Dark Matter Interactions}\label{dmgammaproduction}
    ...
    In collider searches, $ss \rightarrow \chi\chi$, standard model particles ($ss$) are {\color{red}accelerated into (accelerated into? What do you mean?? -maria)} each other within a detector, and the resulting particle fragments are measured by a slew of {\color{red}measuring equipment (which kind of measuring equipment?? -maria)}.
    ...
    For direct searches, $\chi s \rightarrow \chi s$, sensitive particle detectors are built {\color{red}deep underground (why underground? what's the benefit?? -maria)}, where a dark matter particle impacting against an electron or nuclei creates a detectable recoil.
    This recoil can cause a detectable charge, an {\color{red}increase in temperature, an acoustic vibration, or a visual reaction like a photon or a gas bubble in a liquid (why increase in temperature, visual reaction, etc?? -maria)}, so detectors are built to measure some of these effects.
...
\section{Galactic Center}
  ...
  The Galactic Center is also a source of TeV {\color{red} gamma rays (how do we know that? do you have a refererence?? -maria)}, though the mechanism that produces them is still under debate.
...
\section{Indirect Dark Matter Search}
  For this analysis, it is important to understand how a {\color{red}terrestrial telescope can detect the presence of dark matter (That's not only important for this analysis here, isn't it..?? -maria)}.
  ...
  \subsection{Dark Matter Halo Structure}\label{dm_spatial}
    ...
    \begin{figure}[ht]
      ...
      \caption[Galactic Center Einasto Halo Density]{
        ...
        {\color{red}('distance from GC' in axes label should be 'Distance from Galactic Center' ??)}
        \CaptionBlankLine
        }
      \label{fig:gchalo_density}
    \end{figure}

    Other density profiles exist, but for this analysis only the {\color{red}Einasto profile is considered (why did you choose this one?? -maria)}.
    ...
    For simplicity of implementation, only a {\color{red}cuspy (Do you have another word for it? it sound a bit like slang, doesn't the profile has a typical name (Gauss or King etc)?? -maria)} halo is used in this thesis.
    ...
    \centering
      ...
      \caption[Galactic Center Einasto Halo Jfactor]{
        ...
        {\color{red}(top x axis should be Galactic Center, not GC??)}
      }
  ...
  \begin{figure}[ht]
    ...
    \caption[Galactic Center Halo J-factor Skymap]{
      ...
      {\color{red}Change x and y axis labels to Galactic Longitude (l) and Galactic Latitude (b).}
    }
  ...
  \subsection{Spectrum of Gamma Rays from Dark Matter}\label{dm_spectral}
    ...
    For this analysis, {\color{red}only the $b\bar{b}$ annihilation channel is considered (why only this channel?? -maria)}.
...
\section{Atmospheric Showers}
  ...
  {\color{red}(Explain this effect more. How do we know that this is Cherenkov radiation. Does every particle produce Cherenkov radiation? What is the limit?  I would separate the air shower development and the production of Cherenkov radiation here. ?? -maria )}
  ...
  The initial energies were chosen because a \SI{1}{TeV} proton will on average divest $\frac{1}{3}$ of its energy to the $\pi^{0}$ {\color{red}(Why not using showers at the same energy?? -maria)}.
