...
\section{Production of TeV Gamma Rays}
  ...
  In general, this acceleration {\color{red}imparts energy (how much?? add equation and maybe a figure here -maria)} to charged particles when they are reflected by an oncoming magnetic field.
  
  {\color{red}(pause in adding maria's comments, around line 672 ??)}
