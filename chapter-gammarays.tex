...
\section{Production of TeV Gamma Rays}
  ...
  As the magnetic field lines merge (Figures \ref{fig:magcon}.b and c), induced current flows produce electric fields (Figure~\ref{fig:magcon}.d) that {\color{red}can accelerate (what is the mechanism called?? -maria)} charged particles~\cite{magcon_crab,magcon_schopper,magcon_review,gamma_pwn1,gamma_pwn2,magconsim2011,magconsim2014}.
  ...
  This background is irreducible due to the fact that proton and gamma-ray air showers are very similar, and cannot be identified with perfect accuracy.
