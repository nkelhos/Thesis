...
\section{Production of TeV Gamma Rays}
  ...
  {\color{red}(I think the latest measurement by HESS went to energies of up to a few TeV. Maybe look at the proceedings from last year's ICRC for that? Would probably not change much the numbers at the rest of the paragraph, but you should take the latest values. ?? -orel)}
  ...
  {\color{red}(This paragraph looks out-of-place. Did it move by accident?? -orel)}
  ...
  {\color{red}(Maybe add just one sentence saying that protons can be accelerated in the same way as the electrons you discussed before, just to give it a bit more importance?? maybe just remove 'inverse compton', since this is included in the 'dust along the galactic plane'  -orel)}
