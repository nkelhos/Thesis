...
\section{Methods of Creation}
  ...
  The $\pi^{0}$ then quickly (\SI{8.5e-17}{s}~\cite{pdg2016}) decomposes into two gamma ras, each with \nicetilde$15\%$ of the original proton's energy.
...
\section{Indirect Dark Matter Search}
  ...
  \subsection{Dark Matter Halo Structure}\label{dm_spatial}
    ...
    Sometimes, the density integral in Equation~\ref{eqn:dmflux} is calculated separately, as in Equation~\ref{eqn:jfactor}, and is referred to as the $J$ factor.
  ...
  For example, if dark matter WIMPs have an attractive force between them, their effective annihilation crosssection is enhanced, increasing the halo's gamma-ray emission.
