...
\section{Production of TeV Gamma Rays}
  ...
  {\color{red}(ask orel if this is still out of place?? -orel)}
...
\section{Galactic Center}
  ...
  At its heart, kinematic observations of nearby stars can be used to infer the presence of a supermassive black hole, with a mass of \SI{4e6}{ \Msol{} }~\cite{sgra_massdist}.
...
\section{Indirect Dark Matter Search}
  ...
  \subsection{Spectrum of Gamma Rays from WIMP Annihilations}\label{dm_spectral}
    ...
    The distribution of these annihilations depends on the dark matter density, which is discussed after this in Section~\ref{dm_spatial}.
    ...
    {\color{red}(weave these two paragraphs (above and below) into a single coherent paragraph?? -orel)}
    ...
    {\color{red}(These "mix of channels" are referred to as branching ratios. I am not sure you need the long explanation though. Probably enough to say that you are searching only in the bb channel and whatever you assume the branching ratio for this channel is (what is it actually? 100\% ?? -orel)}
  ...
  \subsection{Dark Matter Halo Structure}\label{dm_spatial}
    ...
    {\color{red}(line 841: Not sure I understand how Figure 3.8 is calculated using Equation 3.11 when the y-axis is just the J factor. I thought it would be just Eq 3.12. Maybe you explain it to me in a quick chat?? -orel )}
...
\section{Atmospheric Showers}\label{sec:atmoshowers}
  ...
  {\color{red}(equation should be p + nucleon -> ???)}
