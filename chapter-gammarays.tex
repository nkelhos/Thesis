...
\section{Production of TeV Gamma Rays}
  ...
  Because the magnetic field lines merge (Figures \ref{fig:magcon}.b and c), this causes the ambient plasma in the region to move with the magnetic field lines{\color{red}(rewrite to be a little more vague??)}.
  ...
  {\color{red}(just say, for a given proton energy in earth's rest frame, what would the final photon energy be? I don't need to do the full frame-of-reference-shift calculation to figure out the photon energy distribution.  ??)}
...
\section{Galactic Center}
  ...
  The second possibility suggests a nearby population of millisecond pulsars may be accelerating electrons, which then upscatter local photons to TeV energies~\cite{gc_pulsars}.
  {\color{red}(make sure to reference 1506.05104 and 1506.05124 ??)}
  ...
  One of these sources is a disk of dust along the galactic plane, acting as an interaction medium for diffuse proton cosmic rays.
...
\section{Indirect Dark Matter Search}
  ...
  \subsection{Spectrum of Gamma Rays from Dark Matter}\label{dm_spectral}
    ...
    {\color{red}(mention how j factor can have large uncertainties, as discussed in 1506.08209 ??)}
