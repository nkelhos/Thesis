...
\section{Production of TeV Gamma Rays}
  ...
  For Inverse Compton scattering, a field of photons will gain energy according to Equation~\ref{eqn:inv_compt_en_gain_rate}~\cite{inv_compt1,inv_compt2},
  ...
  For example, a green photon ($\lambda{}=550\,\textrm{nm}$, $E_{green}=0.3\,\textrm{eV}$) would get scattered up to \SI{300}{keV}, becoming a {\color{red}(a what??)}.
  {\color{red}(recheck all this math!!!??? something is off!! )}
  ...
  \begin{figure}[ht]
    ...
    \caption[Inverse Compton Scattering Feynman Diagram]{
      ...
      {\color{red}(switch this to a green and x-ray photon)}
    }
