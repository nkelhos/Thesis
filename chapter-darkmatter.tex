...
\section{Astrophysical Evidence for Dark Matter}
  ...
  \subsection{Scales of $10^{23}\:\text{m}$ : Galaxy Clusters}\label{dm_galclusters}
    ...
    Within \SI{20}{$h_{700}^{-1}$ kpc} of the center, the ratio is 12 \MLsol, while beyond a radius of \SI{200}{$h_{70}^{-1}$ kpc} the ratio rises above 100 \MLsol{}, indicating a high amount of dark matter is present~\cite{cluster_chandra}.
