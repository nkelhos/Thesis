...
\section{Astrophysical Evidence for Dark Matter}
  ...
  \subsection{Scales of $10^{19}\:\text{m}$ : Dwarf Galaxies}\label{dm_dwarfscale}
    ...
    When Equations~\ref{eqn:virial,eqn:kineticen,eqn:potentialen} are combined, $M$ can be solved for, only as a function of the velocities{\color{red}(??)}.
  ...
  \subsection{Scales of $10^{23}\:\text{m}$ : Galaxy Clusters}\label{dm_galclusters}
    ...
    The difference in position between the two centers of mass allows for constraints to be put contraints on the mass and crosssection.
...
\section{Particle Dark Matter}\label{sec_particledm}
  ...
  When observations are made of earlier times, the opposite is found: galaxy-scale gravitational wells form first, then cluster-scale wells, then super-cluster-scale wells in present times, called bottom-up.
