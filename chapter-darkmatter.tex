...
\section{Supersymmetry, $\Lambda$CDM, and Dark Matter}
...
While there hasn't been any evidence of supersymmetry detected to date(cite??), it is motivated primarily as a mechanism for predicting physics across a large range energy scales, the holy grail of any Grand Unified Theory.

As dark matter has influence at the smallest and largest scales, its context in cosmology must also be discussed.
In cosmology, $\Lambda$CDM, or $\Lambda$ Cold Dark Matter, is the existing model of cosmology.
...
A large part of $\Lambda$CDM is predicted by measuring fluctuations in the Cosmic Microwave Background (CMB).
...
For dark matter, the favored supersymmetric candidate particle is the neutralino, as dark matter as other supersymmetric partners would show up in other searches.
The neutralino is a linear combination of the photon, the $Z^{o}$ boson, and the neutral Higgs boson.
