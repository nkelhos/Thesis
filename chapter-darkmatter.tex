...
\section{Astrophysical Evidence for Dark Matter}
  ...
  \subsection{$10^{19}\:\text{m}$ : Dwarf Galaxy Scale}
    ...
    {\color{red}(Add here the ratio of M/L as well -Orel ??)}
    ...
    {\color{red}(Please expand the introducion of this additional piece of evidence (“Another evidence for the existence of dark matter in the dwarf galaxies…..”)  ??)}   
  ...
  \subsection{$10^{20}\:\text{m}$ : Galaxy Scale}
    ...
    With one method, the total amount of light produced by a quadrant of a galaxy is measured with telescopes.
    {\color{red}(Are you discussing a method of observing here or the actual effect? I think you should first explain what is the effect observed at the galaxy scale, I really could not understand it from this explanation. -Orel ??)}
    ...
    By comparing the orientation of the disk with the doppler-shifted position of well-known spectral lines, one can calculate the average velocity that each section is travelling at around the center of the galaxy, forming a rotation curve (\cite{rotation_curve_review}, \cite{spiral_galaxy_rot_curve}, \cite{milkyway_dm_evidence}).
    Newton's law of gravity can then be used to calculate the mass contained within a sphere of that same radius.
    This calculation ends up with a larger amount of mass.
    {\color{red}(Please expand. A larger amount of mass than what? Get from it to why dark matter is the proposed solution, etc.section of the galaxy. -Orel ??)}
...
\section{Particle Dark Matter}
  ...
  {\color{red}(In this case it is OK to refer to \cite{DMPrimer} for other candidates beyond the scope of this thesis. You should write “See Ref. [20]” though. -Orel ??)}
