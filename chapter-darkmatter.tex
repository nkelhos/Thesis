...
\section{Indirect Dark Matter Detection}
  ...
  \subsection{Dark Matter Halo Structure}\label{dm_spatial}
    ...
    Most simulations show that density profiles should terminate in a sharp peak at $r=0$, but observations of dwarf galaxies instead favor a flat core within a given radius \ref{CoreVsCusp}.
    ...
    The $\left \langle \sigma v \right \rangle$ is the velocity averaged cross-section of the dark matter candidate.
