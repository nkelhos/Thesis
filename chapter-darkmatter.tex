...
\section{Indirect Dark Matter Detection}
  ...
  \subsection{Dark Matter Halo Structure}
    ...
    When using the distance to the galactic center of 8 kpc (cite??), the local estimated dark matter mass density of 0.4 $$\frac{\textrm{GeV}}{\textrm{cm^3}}$$ (cite??), and a scale radius $$r_s$$ of 15.4 kpc (cite??), the einasto density profile for the the galactic center halo looks like figure \ref{fig:gchalo_density}.
  
    \begin{figure}[ht]
      \begin{center}
        \includegraphics[width=0.95\textwidth]{images/halo/gc_einasto_profile.eps}
        \caption[Galactic Center Einasto Profile]{}\label{fig:gchalo_density}
      \end{center}
    \end{figure}
