...
\section{Astrophysical Evidence for Dark Matter}
  ...
  \subsection{Scales of $10^{26}\:\text{m}$ : The Observable Universe}\label{dm_universe}
    ...
    These photons precisely follow a blackbody spectrum, shown in Figure~\ref{fig:cmb_black}, and are called the cosmic micrwave background.
    ...
    These baryons would fall into these gravitational wells, until it became warmer, whereupon it emits more photons, which drive the mass out of the wells.
    Eventually after leaving the wells, the photon pressure dropped and the gravitiational force took over, drawing the matter back towards the gravitational wells again.
    ...
    However, since the baryons were pulled into the high density areas by gravity, the presence of dark matter alters the wavelength of these density ripples, stretching them out (??).
    ...
    \begin{figure}[ht]
      ...
      \caption[Cosmic Micrwave Background Correlation Spectrum]{
        Correlation spectra from temperature measurements with the Planck satellite~\cite{planck2015_cmb_spectra}.
    ...
    Amount of polarization indicates how long the recombination took, longer recombination = more Thompson scattering of CMB photons off un-recombined electrons.
    Lensing by dark matter structures contribute to B-mode polarization of CMB.
    ...
    % https://arxiv.org/pdf/astro-ph/0503486.pdf
    %
    % also https://www.mpifr-bonn.mpg.de/981464/puget.pdf
    % also https://indico.scc.kit.edu/event/75/contributions/3903/attachments/1925/2608/Talk_Ensslin_Planck.pdf
    

    Deuterium abundance??
    Baryon and Deuterium populations linked, and Deuterium is low enough that the mass of baryons that go with it is less than the gravitational mass of everything in the universe.
    Thus baryons can't make up all of mass, most must be non-baryonic.
...
\section{$\Lambda$CDM Cosmology and the Standard Model}
  ...
  Much of $\Lambda$CDM comes from measuring fluctuations in the Cosmic Microwave Background (CMB).
  ...
  Observations of the CMB indicate that it is close to a blackbody spectrum, and deviations from that spectrum are due to Baryon Acoustic Oscillations.
  {\color{red}(You should explain what is learned from the CMB and how. -Orel ??)}
  These oscillations are fitted by a model of $\Lambda$CDM that depend primarily on six free parameters that describe the universe, including:
  
  \renewcommand{\labelitemi}{}
  \begin{itemize}
    \item $\Omega_b$   : Fraction of the universe's energy stored in baryons
    \item $\Omega_c$   : Fraction of the universe's energy stored in (Cold) dark matter
    \item $\theta_{\textrm{MC}}$ : Angular size of the sound horizon at recombination
    \item $\tau$   : Thompson scattering optical depth due to reionization
    \item $A_s$  : Initial super-horizon amplitude of curvature perturbations
    \item $n_s$  : Spectral index of the seed density spectrum in the extremely early universe
  \end{itemize}
