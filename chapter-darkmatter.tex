...
\chapter{$\Lambda$CDM Cosmology}

  At the largest spatial scales, $\Lambda$CDM ($\Lambda$ Cold Dark Matter) is the existing model of cosmology.
  It charts how the universe expanded from the big bang until the present day universe, based many different observations.
  The details it predicts usually revolve around how different particles condensed out of the universe at different times, and their distribution throughout the universe.
  As dark matter makes up 24\% of the universe's energy and 84\% of its mass \cite{wmap9year}, it has a significant impact on the development of the universe and its present day distribution.
  ...
  This include the astrophysical evidence for missing matter, as well as the reasoning for why its likely to be in the form of a new, unknown particle that condensed out earlier in the universe.
...
\section{Particle Dark Matter}
  ...
  While no definitive evidence of supersymmetry has been discovered to date, it is still preferred due to its ability to predict physics across a large range energy scales, the holy grail of any Grand Unified Theory.

  $\Lambda$CDM describes the initial moments after the big bang, as well as how space and matter evolved through time to form the modern observable universe.
