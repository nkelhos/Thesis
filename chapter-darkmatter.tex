...
\section{Astrophysical Evidence for Dark Matter}
  ...
  \subsection{Scales of $10^{23}\:\text{m}$ : Galaxy Clusters}\label{dm_galclusters}
    ...
    At scales of $\nicetilde 10^{23}$m, Dark Matter's effects on galactic clusters become observable with two separate techniques.
    
    Mass-To-Light Ratios
    Velocity dispersions of galaxies within clusters was measured
    Luminosities were measured
    List some ratios here in a table.
    \cite{cluster_ml_ratios}

    Lensing Technique
    Galaxy Clusters Abell 370 and Cluster 2244-02 are very massive, enough to bend light
    Galaxies behind these clusters have their light bent and distorted into arcs
    Modeling these arcs can produce a mass-map of the foreground galaxy cluster
    These mass maps indicate a very high mass-to-light ratio, 100-1000 Msol-over-Lsol
    \cite{cluster_lensing}
    
    Strong Lensing
    Cluster 0024+1654 has 8 subimages of a background galaxy, imaged by hubble
    These 8 images can be used to make a total-mass map
    Known masses can be modeled and subtracted, leaving behind a DM mass halo
    \cite{cluster_strong_lensing}
    ...
    Velocity Dispersion of Galaxies with Clusters
    The velocity dispersion for several clusters was measured
    \cite{}

    Rotational Technique
    Galaxy rotational velocities measured to get total mass
...
compares the total mass of a cluster from gravitational lensing to the luminous mass from optical observations.
    ...
    In the first technique, observations are taken of two galaxy clusters that have recently collided, one of which is called the Bullet Cluster~\cite{bullet_cluster}.
