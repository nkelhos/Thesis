...
\section{Astrophysical Evidence for Dark Matter}
  ...
  \subsection{Scales of $10^{26}\:\text{m}$ : The Observable Universe}\label{dm_universe}
    ...
    During this time, a background population of WIMP dark matter particles were repeatedly created and annihilated.
    ...
    After that freezout, the temperature was low enough that baryon creation and annihilation rates plummeted.
    Because there are no significant ways to destroy universe-scale quantities of baryons, their numbers remain unchanged since this freezout.
...
Also, it does not really explain how dark matter plays a role (you mention it in the next paragraph, but it is not explained). -Orel ?? )}
    ...
    % 4 MACHO papers:
    % http://iopscience.iop.org/article/10.1086/304535/pdf         1997 First two years of the MACHO Project
    % https://journals.aps.org/prl/pdf/10.1103/PhysRevLett.74.2867 1995 Experimental limits on microlensing
    % http://iopscience.iop.org/article/10.1086/311355/pdf         1998 Eros and Macho combined limits
    % http://iopscience.iop.org/article/10.1086/380562/pdf         2004 End of the Macho Era
    % https://www.aanda.org/articles/aa/ps/2003/12/aa3417.ps.gz    2003 5 Years of EROS SMC data
    
    % also: http://iopscience.iop.org/article/10.1088/0034-4885/63/5/2r3/pdf page 809
    %    http://iopscience.iop.org/article/10.1086/312243/meta Stellar remnants  ruled out by TeV gamma rays
    %    https://www.nature.com/articles/365623a0 1993 Eros first data
