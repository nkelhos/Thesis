...
\section{Astrophysical Evidence for Dark Matter}
  ...
  \subsection{Scales of $10^{26}\:\text{m}$ : The Observable Universe}\label{dm_universe}
    ...
    However, since the baryons were pulled into the high density areas by gravity, the presence of dark matter alters the wavelength of these density ripples, stretching them out {\color{red}(??)}.
...
\section{$\Lambda$CDM Cosmology and the Standard Model}
  ...
  Much of $\Lambda$CDM comes from measuring fluctuations in the Cosmic Microwave Background (CMB), discussed in Section~\ref{dm_universe}.
  In these fluctuations, a snapshot of the universe when it was 380,000 years old is preserved, providing many clues as to the development of the universe, including its age, energy content, particle populations, structure, and expansion. 
  ...
  These oscillations are fitted by a model of $\Lambda$CDM that depend primarily on six free parameters that describe the universe~\cite{planck_2013_parameters,planck2015,planck_dm_limit}, including:
