...
\section{Particle Dark Matter}\label{sec_particledm}
  ...
  \begin{equation}\label{eqn:boltzmann_relic}
    \frac{dn}{dt} + 3 H n = \left \langle \sigma_{A} v \right \rangle \left ( n_{eq}^2 - n^2 \right ) \;\;,
  \end{equation}
  
  where $n$ is the comoving WIMP number density, $H$ is the hubble expansion rate ($\frac{\dot{a}}{a}$), $\left \langle \sigma_{A} v \right \rangle$ is the velocity-averaged cross section for $\chi\chi$ annihliating into lighter particles.
