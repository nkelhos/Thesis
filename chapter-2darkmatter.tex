...
\begin{figure}[bt]
  \centering
  \includegraphics[width=0.7\textwidth]{images/sculptor/sculptor.eps}
...
\begin{figure}[tb]
  \centering
  \includegraphics[width=0.7\textwidth]{images/fornax/fornax.pdf}
...
The current paradigm of particle physics is called the Standard Model~\cite{StandardModelMann}.
...
\begin{figure}[!ht]
  ...
  \caption[Relic Abundance vs Time]{
...

    {
      ...
      \rule{0pt}{6.5ex} % extra vertical space
      \begin{tabular}{ll}
