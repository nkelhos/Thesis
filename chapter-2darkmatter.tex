...
\section{$\Lambda$CDM Cosmology and the Standard Model}
  ...
  \begin{table}[]
    ...
    % its radians: from arxiv 1807.06209, equation 7 and the two lines below that
    % https://ned.ipac.caltech.edu/level5/Sept02/Reid/Reid5_2.html , equation 46

    $\tau$     & $(5.40   \pm0.74   )\times 10^{-2}$ & unitless  & Optical depth to reionization\\
    % arxiv: 0205436 , section II, 3rd paragraph
    % reionization optical depth, from https://lambda.gsfc.nasa.gov/education/graphic_history/taureionzation.cfm :
    %   "the optical depth to reionization, τ, is a unitless quantity which provides a measure of the line-of-sight free-electron opacity to CMB radiation"

    $A_s$      & $(2.097  \pm0.029  )\times 10^{-9}$ & unitless   & Seed density spectrum amplitude \\
    % A_s is 'dimensionless': https://arxiv.org/pdf/1303.5076.pdf , paragraph above equation 2
