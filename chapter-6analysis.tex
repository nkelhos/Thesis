...
With more unmodeled events, increasing the $\vacs$ causes the likelihood to decrease at earlier (smaller) $\vacs$'s, which results in a smaller upper limit (see Section~\ref{upper_limit}) that eliminates more of the parameter space.
