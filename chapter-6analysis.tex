...
{\color{red}(how does Figure~\ref{fig:} look like without th ose edge bins? is it the expected N(0,1) normal distribution?? -gernot)}
{\color{red}(butt there is clearly a systematic offset in the background: where do you discuss the possible reason for that?? -gernot)}
