...
When a significance distribution is made of Figure~\ref{fig:crab_signif_skymap_coarse}'s pixels, and all bins with zero observed counts are cut, it is seen in Figure~\ref{fig:crab_signif_distribution} to follow a Gaussian distribution.
{\color{red}(previous sentence??)}
...
Before creating the histogram and simulations, all bins with zero observed counts are first cut.
{\color{red}(previous sentence ok??)}
