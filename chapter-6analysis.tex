...
\section{Likelihood Ratio Test}\label{sec:likeratio}
  ...
  This function can be integrated over the energy, sky, and time region covered by a bin $j$ to calcuate the number of events predicted in that bin, as shown by 
...
\section{Dark Matter Likelihood Analysis}\label{sec:dmlike}
  ...
  It was later found to not be consistant with a dark matter halo~\cite{gc_pnt_is_not_dm1, gc_pnt_is_not_dm2, gc_pnt_is_not_dm3}.
