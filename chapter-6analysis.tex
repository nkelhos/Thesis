...
The dark matter limits may change if these parameters are instead left free, however with more free parameters the likelihood maximization process has a tendency to converge to no-physical values and fail, so in this first-step analysis these parameters are left fixed.
