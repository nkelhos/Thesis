...
\section{Crab Nebula Likelihood Analysis}\label{sec:crab_analysis}
  ...
  \begin{figure}[p]
    \centering
    %\includegraphics[width=0.85\textwidth]{images/test_crab_analysis/plot_elev27_5_32_5deg_4_70TeV_wobbleall_Epochall_showclean_spl.pdf}
    %\includegraphics[width=0.85\textwidth]{images/test_crab_analysis/elev27_5_32_5deg_4_70TeV_wobbleall_Epochall_spl_niceprofile.pdf}
    \includegraphics[width=0.85\textwidth]{images/test_crab_analysis/plot_elev27_5_32_5deg_4_70TeV_profiledata_spatiall_json.pdf}
    \llap{
        ...
        \raisebox{5.2cm}{     % y position
          {
            ...
            \fbox{
              \includegraphics[height=4cm]{images/test_crab_analysis/plot_elev27_5_32_5deg_4_70TeV_wobbleall_Epochall_profl_skymap_rasterized.pdf}
            }
          }
        }
      }
  ...
  \begin{figure}[p]
    \centering
    %\includegraphics[width=0.85\textwidth]{images/test_crab_analysis/plot_elev27_5_32_5deg_4_70TeV_wobbleall_Epochall_showclean_spb.pdf}
    %\includegraphics[width=0.85\textwidth]{images/test_crab_analysis/elev27_5_32_5deg_4_70TeV_wobbleall_Epochall_spb_niceprofile.pdf}
    \includegraphics[width=0.85\textwidth]{images/test_crab_analysis/plot_elev27_5_32_5deg_4_70TeV_profiledata_spatialb_json.pdf}
    \llap{
      \makebox[13cm][l]{ % x position
        \raisebox{5.2cm}{  % y position
          {
            ...
            \setlength{\fboxrule}{1pt}
            \fbox{
              \includegraphics[height=4cm]{images/test_crab_analysis/plot_elev27_5_32_5deg_4_70TeV_wobbleall_Epochall_profb_skymap_rasterized.pdf}
            }
          }
        }
      }
  ...
  \begin{figure}[p]
    \centering
    %\includegraphics[width=0.85\textwidth]{images/test_crab_analysis/plot_elev27_5_32_5deg_4_70TeV_wobbleall_Epochall_showclean_splalt.pdf}
    %\includegraphics[width=0.85\textwidth]{images/test_crab_analysis/elev27_5_32_5deg_4_70TeV_wobbleall_Epochall_splalt_niceprofile.pdf}
    \includegraphics[width=0.85\textwidth]{images/test_crab_analysis/plot_elev27_5_32_5deg_4_70TeV_profiledata_spatiallalt_json.pdf}
    \llap{
        ...
        \raisebox{6.8cm}{  % y position
          {
            ...
            \setlength{\fboxrule}{1pt}
            \fbox{
              \includegraphics[height=2.4cm]{images/test_crab_analysis/plot_elev27_5_32_5deg_4_70TeV_wobbleall_Epochall_profa_skymap_rasterized.pdf}
            }
          }
        }
      }
  ...
  \begin{figure}[p]
    \centering
    %\includegraphics[width=0.85\textwidth]{images/test_crab_analysis/plot_elev27_5_32_5deg_4_70TeV_wobbleall_Epochall_ep.pdf}
    %\includegraphics[width=0.85\textwidth]{images/test_crab_analysis/elev27_5_32_5deg_4_70TeV_wobbleall_Epochall_en_niceprofile.pdf}
    \includegraphics[width=0.85\textwidth]{images/test_crab_analysis/plot_elev27_5_32_5deg_4_70TeV_profiledata_energy_json.pdf}
    \llap{
      \makebox[9.9cm][l]{  % x position
        \raisebox{5.4cm}{ % y position
          {
            \setlength{\fboxsep}{0pt}
            \setlength{\fboxrule}{1pt}
            \fbox{
              \includegraphics[height=3.7cm]{images/test_crab_analysis/plot_elev27_5_32_5deg_4_70TeV_wobbleall_Epochall_profe_skymap_rasterized.pdf}
            }
          }
        }
      }
  ...
  For the Crab Nebula, two skymaps are shown in Figure~\ref{fig:crab_signif_skymaps}.
  
  
  \begin{figure}[t]
    \centering
    \includegraphics[width=0.95\textwidth]{images/test_crab_analysis/crab_signif_joined.pdf}
    \caption{
      Skymaps showing how significantly the models differ from the observations in each bin.
      The left plot uses \ang{0.23}-wide bins, while the right uses \ang{0.029}-wide bins.}
    \label{fig:crab_signif_skymaps}
  \end{figure}

  However, due to the low number of counts in each bin, the significance distribution that would be formed is not gaussian, and thus unlikely to be a true significance.
  When a significance distribution is made of Figure~\ref{fig:crab_signif_skymaps}'s fine-binned plot, it is seen to be quite erratically shaped in Figure~\ref{fig:crab_signif_distribution}.
  ...
  \begin{figure}[h]
    \centering
    \includegraphics[width=0.95\textwidth]{images/test_crab_analysis/plot_elev27_5_32_5deg_4_70TeV_mapresiduals_fine_hist.pdf}
    \caption{
      Data and simulated significance distributions from the fine-binned significance skymap in Figure~\ref{fig:crab_signif_skymaps}.
...
\section{Dark Matter Likelihood Analysis}\label{sec:dmlike}
  ...
  {\color{red}(remove this, its discussed in the crab analysis??)}
  To check for any poorly modeled areas of the sky, the difference between the observed counts and models can be examined.
  However, while a simple residual may provide some insight, it is far better to calculate how significantly the observed counts ($D$) and modeled counts ($M$) differ in different parts of the sky.
  This significance is derived through a likelihood calculation.
  Two hypotheses are constructed, the null and the test.
  ...
  % had to break this equation up, since it was overlapping the page number at the bottom of the page
  %\begin{equation}
  %  \begin{split}
  %    \textrm{TS} & = 2 \: \textrm{ln} \left ( \frac{ L_{\textrm{test}} }{ L_{\textrm{null}}    } \right ) \\
  %                & = 2 \: \textrm{ln} \left ( \frac{ P_{\textrm{test}} }{ P_{\textrm{null}}    } \right ) \\
