...
\section{Crab Nebula Likelihood Analysis}\label{sec:crab_analysis}
  ...
  \begin{figure}[tb]
    ...
    \includegraphics[width=0.75\textwidth]{images/test_crab_analysis/plot_elev27_5_32_5deg_4_70TeV_nfits165_mapcounts.pdf}
...
\section{Dark Matter Likelihood Analysis}\label{sec:dmlike}
  ...
  {\color{red}(why does the equation stick out over the line edge??)}
  ...
  The dark upper-left and lighter lower-right areas are due to the the radially-symmetric background, which poorly models the not-radially-symmetric atmosphere {\color{red}(should be rephrased as well (and honestly I would like to understand the problem again) ?? -orel)}.
