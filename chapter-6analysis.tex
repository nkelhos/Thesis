...
\section{Likelihood Ratio Test}\label{sec:likeratio}
  ...
  {\color{red}(less powerful, some information lost?? dad)}
  ...
  {\color{red}(each source of events... a single gamma ray?? -dad)}
  ...
  {\color{red}(arrows at $M_s$, $M_e$, $M_t$?? -dad)}
  {\color{red}(where do these substitution equations come from?? -dad)}
  ...
  {\color{red}(illegible comment from dad??)}
  ...
  {\color{red}(where did this equation come from?? -dad)}
