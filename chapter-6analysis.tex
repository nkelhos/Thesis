...
{\color{red}(hows this look from here down to 'From the nine WIMP masses...' paragraph??)}
...
With a Chi-squared distribution with 1 degree of freedom, the significance $\sigma$ of observing a decrease in likelihood $\Delta\LogLike$ can be found by
...
%In this situation,  with $n$ degrees of freedom.
%As the $\vacs$ is the only free parameter, $n=1$, and the significance of calculating


%is shaped like a Gaussian distribution, as shown in Figure~\ref{fig:ulimitdiag}.
