...
plt.text( 1.16, 0.96, r'$P=10^{ \left (\gamma + 1 \right ) \log_{10}{\beta}}$', fontsize=fs+5 )

plt.title( 'Spectral Index Contours', fontsize=fs+3 )
...
plt.text( 4, 1.5, r'$\frac{dN}{dE} = \left ( \frac{E}{1\,\textrm{\LARGE TeV}} \right )^{\gamma} $', fontsize=fs+8, ) # bbox={'facecolor':'white','edgecolor':'black','linewidth':0.5} )
#plt.annotate( r'$\frac{dN}{dE} = \left ( \frac{E}{1\,\textrm{\LARGE TeV}} \right )^{\gamma} $', xy=[4,1.5], fontsize=fs+8, bbox={'facecolor':'white'} )

plt.title( 'Differential Spectra of Power Laws with Spectral Indicies', fontsize=fs+3 )
