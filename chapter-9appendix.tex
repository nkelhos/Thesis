...
The residual significance skymap from the Crab Nebula analysis in Section~\ref{sec:crab_analysis} is shown again in Figure~\ref{fig:resmap_sigdist_crab_coarse}.
...
\begin{figure}[h]
  ...
  \begin{minipage}{0.45\textwidth}
    \centering
    \includegraphics[width=\linewidth]{images/test_crab_analysis/plot_elev27_5_32_5deg_4_70TeV_nfits165_mapresiduals_coarse_hist.pdf}
  \end{minipage}
  \hfill
  \hfill
...
\begin{figure}[h]
  ...
  \begin{minipage}{0.45\textwidth}
    \centering
    \includegraphics[width=\linewidth]{images/test_crab_analysis/plot_elev27_5_32_5deg_4_70TeV_nfits165_mapresiduals_fine_hist.pdf}
  \end{minipage}
  \hfill
  \hfill
