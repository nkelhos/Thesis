...
\section{Camera Studies}
  ...
  It should be noted that there is a time-dependent rotation applied to go from the Camera X/Y (Earth Azimuth/Elevation) system to the Galactic (l,b) coordinates, which smears out the shape of the deficit.
  ...
  \subsubsection{Diffuse Simulations}\label{subsubsec:diffusesims}
    ...
    To approximate a simple gamma-hadron cut, any events with a mean-scaled-width falling outside the range of -2.0 to 0.5 were removed, which removes many of the showers that appear proton-like.
