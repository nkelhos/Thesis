...
\section{Camera Studies}
  ...
  \subsubsection{Diffuse Simulations}\label{subsubsec:diffusesims}
    ...
    (The top-of-camera vs bottom-of-camera differences are due to the atmosphere, but I'm not sure what causes the deficit in the middle at the lower energies... ??)
