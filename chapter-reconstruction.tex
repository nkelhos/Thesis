...
\begin{figure}[ht]
  \begin{center}
    ...
    \caption[PSF Parameter Space]{The 68\% containment radius for the Energy/Offset parameter space for Galactic Center run 78128. (make these plots bigger!?? -Orel) (and shorten the x dimension of the plot!??)}\label{fig:psf_paramspace}
  \end{center}
\end{figure}
...
plot of galactic center (all energies vs @2 \TeV ) !??
