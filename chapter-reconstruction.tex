...
\section{Camera Studies}
  ...
  %\begin{figure}[ht]
    %\begin{center}
      %\includegraphics[width=0.95\textwidth]{images/background_vs_elevation/background_vs_elevation_srccrab_enhist.eps}
      %\caption[Cap A]{Desc A}\label{fig:label_a}
    %\end{center}
  %\end{figure}
      ...
      \begin{figure}[h]
        \includegraphics[width=\textwidth]{images/background_vs_elevation/background_vs_elevation_srccrab_enhist.eps}
        \caption[Background vs Elevation Crab Energy Histogram]
        {\small Number of events in each energy bin from a series of Crab observations.}
        \label{fig:bkgvsel_crab_enhist}
      \end{figure}
      
      \begin{figure}[h]
        \includegraphics[width=\textwidth]{images/background_vs_elevation/background_vs_elevation_srcsgra_enhist.eps}
        \caption[Background vs Elevation Sgr A* Energy Histogram]
        {\small Number of events in each energy bin from a series of Sgr A* observations.}
        \label{fig:bkgvsel_sgra_enhist}
      \end{figure}

      \begin{figure}[h]
        \includegraphics[width=\textwidth]{images/background_vs_elevation/background_vs_elevation_srccrab_enlarge.eps}
        \caption[Background vs Elevation Crab Event Skymap over Full Energy Range]
        {\small Skymap of events with energies from \SI{1.5}{TeV} - \SI{70}{TeV}, from a series of Crab observations.}
        \label{fig:bkgvsel_crab_enlarge}
      \end{figure}

      \begin{figure}[h]
        \includegraphics[width=\textwidth]{images/background_vs_elevation/background_vs_elevation_srcsgra_enlarge.eps}
        \caption[Background vs Elevation Sgr A* Event Skymap over Full Energy Range]
        {\small Skymap of events with energies from \SI{1.5}{TeV} - \SI{70}{TeV}, from a series of Sgr A* observations.}
        \label{fig:bkgvsel_sgra_enlarge}
      \end{figure}

      \begin{figure}[h]
        \includegraphics[width=\textwidth]{images/background_vs_elevation/background_vs_elevation_srccrab_ensmall.eps}
        \caption[Background vs Elevation Sgr A* Event Skymap over a Small Energy Range]
        {\small Skymap of events with energies from \SI{1.5}{TeV} - \SI{3.25}{TeV}, from a series of Crab observations.}
        \label{fig:bkgvsel_crab_ensmall}
      \end{figure}

      \begin{figure}[h]
        \includegraphics[width=\textwidth]{images/background_vs_elevation/background_vs_elevation_srcsgra_ensmall.eps}
        \caption[Background vs Elevation Sgr A* Event Skymap over a Small Energy Range]
        {\small Skymap of events with energies from \SI{1.5}{TeV} - \SI{3.25}{TeV}, from a series of Sgr A* observations.}
        \label{fig:bkgvsel_sgra_ensmall}
      \end{figure}
