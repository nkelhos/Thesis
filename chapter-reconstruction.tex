...
\section{FITS Conversion for Gammalib and CTOOLs}\label{fitsconversion}
  ...
  The point spread function (sometimes referred to as psf) quantifies the distribution of true positions for a reconstructed position, needed for identifying point sources and extended spatial structures, and is described in subsection \ref{subsec:psf}.
