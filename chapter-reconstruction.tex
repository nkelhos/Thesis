...
\begin{figure}[ht]
  \begin{center}
    ...
    \caption[CTOOLS Background at \nicetilde26\degree Elevation]{10(livetime??) Sagittarius A* Off runs, between elevations 24\degree and 27.5\degree.}\label{fig:back_lowelev26}
  \end{center}
\end{figure}
