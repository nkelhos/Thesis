...
\begin{figure}[ht]
  \begin{center}
    \includegraphics[width=0.75\textwidth]{images/effarea_plots/effarea_gc_events_histogram.eps}
    \caption[Effective Area Parameter Space]{}\label{fig:effarea_paramspace}
  \end{center}
\end{figure}
