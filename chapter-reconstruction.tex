  ...
  \subsection{Background Structure at the Low Energy Threshold}
    ...
    \begin{figure}[ht]
      ...
      \caption[FITS Background at \ang{50} Elevation]{
        ...
        (change axes labels to only use Camera X and Y to be consistant with paragraph text --Orel??)
      }
  ...
  \subsubsection{Diffuse Simulations}\label{subsubsec:diffusesims}
    ...
    \begin{figure}[ht]
      ...
      \caption[Diffuse Simulated Backgrounds]{
        Diffuse simulated gamma-like events in the camera coordinate system at a \ang{28} elevation, at 4 different energies.
      }
