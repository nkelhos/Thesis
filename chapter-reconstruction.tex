...
\begin{figure}[ht]
  \begin{center}
    ...
    \caption[PSF Parameter Space]{The 68\% containment radius for the Energy/Offset parameter space for Galactic Center run 78128. (make these plots bigger!?? -Orel)}\label{fig:psf_paramspace}
  \end{center}
\end{figure}
