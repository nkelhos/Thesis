...
The psf is calculated like a normal resolution, as the distribution of true event directions for a given reconstructed event direction, usually as a function of distance from the reconstructed event direction.
