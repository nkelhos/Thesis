...
In ??, the fourth telescope was finished, and this is considered the fourth epoch.

In ??, Telescope ?? was moved to a new position, after it was demonstrated that there would be an improvement in sensitivity.
This is the fifth epoch.

In ??, the PMTs in all cameras were replaced with improved PMTs that had a higher quantum efficiency, improving the telescopes ability to resolve images.
This is the sixth epoch.
