...
If the low-gain trigger pulse was also recieved by the FADC, then the signal voltage pulse is sent to a separate low-gain circuit, one that does not amplify the voltage pulse before digitizing it.
