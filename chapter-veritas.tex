...
During regular observations, these cameras take images of background stars and the focal plane LEDs every two seconds and matching the star positions, an improved pointing accuracy of \nicetilde{}\ang{0.007} can be achieved.
%originally in griffin thesis 2016, pg45, but is there a better citation??
% 25 arcseconds -> 25/3600 -> 0.006944 deg -> rounded t0 0.007 deg
...
{\color{red}(add diagram of CFD pulses??)}
